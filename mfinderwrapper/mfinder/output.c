...
print_private_help() {
    ...
    printf("\t-oo : No output mode. Default with output \n");
    printf("\t-oi : output intermediate output file. Defualt :No: \n");
